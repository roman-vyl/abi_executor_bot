...
// multi-process ABI is a non-goal (design.md §6). The chained "tail" always
// settles regardless of whether the previous task resolved or rejected, so
// a failing request never wedges the key for the next request — this is a
